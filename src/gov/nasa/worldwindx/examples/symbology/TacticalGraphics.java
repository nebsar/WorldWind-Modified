 ...
 * href="https://goworldwind.org/developers-guide/symbology/" target="_blank">Symbology
 * Usage Guide</a> for more information on symbology support in WorldWind.
 * <p/>
 * See the {@link TacticalSymbols} for a detailed example of using WorldWind
 * tactical symbols in an application.
 *
 * @author pabercrombie
...
public class TacticalGraphics extends ApplicationTemplate {
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame {
        ...
        protected void createPointGraphics(RenderableLayer layer) {
            ...
            /////////////////////////////////////////////
            graphic = factory.createPoint("GFGPGPWA------X", Position.fromDegrees(35.2144, -117.8824), null);
            graphic.setValue(AVKey.DISPLAY_NAME, "Nuclear Event (2.X.3.4.2)");
            graphic.setText("X691");
            graphic.setAttributes(sharedPointAttrs);
        ...
        protected void createLineGraphics(RenderableLayer layer) {
            ...
            graphic = factory.createGraphic("GFGPOLKGM-----X", null, null);
        ...
        protected void createAreaGraphics(RenderableLayer layer) {
            ...
            positions = Arrays.asList(
                    Position.fromDegrees(35.0459, -117.3795),
                    Position.fromDegrees(35.0459, -117.5633),
                    Position.fromDegrees(35.4459, -117.3795),
                    Position.fromDegrees(35.4459, -117.5633));
            ...
            positions = Arrays.asList(
                    ...
                    Position.fromDegrees(35.4459, -117.3795),
                    Position.fromDegrees(35.4459, -117.5633));
            graphic = factory.createGraphic("GFMPBCB-------X", positions, null);
            graphic.setValue(AVKey.DISPLAY_NAME, "Obstacle Gap (2.X.2.5.2.2.2.1)");
            layer.addRenderable(graphic);
            ...
            positions = Arrays.asList(
                    ...
                    Position.fromDegrees(35.4459, -117.3795),
                    Position.fromDegrees(35.4459, -117.5633));
            graphic = factory.createGraphic("GFMPOGF-------X", positions, null);
            graphic.setValue(AVKey.DISPLAY_NAME, "Obstacle Free Area (2.X.3.1.1.4)");
            layer.addRenderable(graphic);
            ...
            positions = Arrays.asList(
                    ...
                    Position.fromDegrees(35.4459, -117.3795),
                    Position.fromDegrees(35.4459, -117.5633));
            graphic = factory.createGraphic("GFMPOGR-------X", positions, null);
            graphic.setValue(AVKey.DISPLAY_NAME, "Obstacle Restricted Area (2.X.3.1.1.5)");
            layer.addRenderable(graphic);
            ...
            positions = Arrays.asList(
                    ...
                    Position.fromDegrees(35.4459, -117.3795),
                    Position.fromDegrees(35.4459, -117.5633));
            graphic = factory.createGraphic("GFMPOGZ-------X", positions, null);
            graphic.setValue(AVKey.DISPLAY_NAME, "Obstacle Zone");
            layer.addRenderable(graphic);
         ...
         * @param pointAttrs Attributes to apply to TacticalPoint graphics
         * graphics.
         */
    ...
    public static void main(String[] args) {
        ...
        Configuration.setValue("gov.nasa.worldwind.avkey.MilStd2525IconRetrieverPath", "jar:file:milstd2525-symbols.zip!");
